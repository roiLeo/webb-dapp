...
import { ActiveWebbRelayer, WebbRelayer, WebbRelayerBuilder } from '@webb-dapp/react-environment';
import { SpaceBox } from '@webb-dapp/ui-components/Box';
import { CloseButton } from '@webb-dapp/ui-components/Buttons/CloseButton';
import { RelayerInput, FeesInfo, RelayerApiAdapter } from '@webb-dapp/ui-components/Inputs/RelayerInput/RelayerInput';
...
export const RelayerModal: React.FC<RelayerModalProps> = ({ note, state, methods, onChange, onClose }) => {
  ...
  return (
    <RelayerModalWrapper>
      ...
      { note ? (
        ...
        <div>
          <Typography variant={'h4'}>
            Enter a note to configure the relayer
          </Typography>
        </div>
      )}
    </RelayerModalWrapper>
